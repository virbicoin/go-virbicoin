...
func TestAccountListEmpty(t *testing.T) {
	gvbc := runGvbc(t, "account", "list")
	gvbc.ExpectExit()
}

func TestAccountList(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	gvbc := runGvbc(t, "account", "list", "--datadir", datadir)
...
func TestAccountNew(t *testing.T) {
	gvbc := runGvbc(t, "account", "new", "--lightkdf")
	defer gvbc.ExpectExit()
	gvbc.Expect(`
...
func importAccountWithExpect(t *testing.T, key string, expected string) {
	...
	gvbc := runGvbc(t, "account", "import", keyfile, "-password", passwordFile)
	defer gvbc.ExpectExit()
...
func TestWalletImport(t *testing.T) {
	gvbc := runGvbc(t, "wallet", "import", "--lightkdf", "testdata/guswallet.json")
	defer gvbc.ExpectExit()
	gvbc.Expect(`
!! Unsupported terminal, password will be echoed.
...
func TestUnlockFlag(t *testing.T) {
	gvbc := runMinimalGvbc(t, "--port", "0", "--ipcdisable", "--datadir", tmpDatadirWithKeystore(t),
