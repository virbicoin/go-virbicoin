...
// Package fileutil provides a minimal file-locking implementation derived from
// github.com/prometheus/tsdb/fileutil. Only the Flock/Releaser functionality is
// retained so that the package builds on all supported architectures, including
// windows/arm64 (the upstream mmap helpers were architecture-restricted and are
// not used by go-virbicoin).
package fileutil
