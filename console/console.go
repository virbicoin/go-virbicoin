...
// Welcome show summary of current Gvbc instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gvbc JavaScript console!\n\n"

	// Print some generic Gvbc metadata
