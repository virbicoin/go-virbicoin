...
| **vbc-pool** | マイニングプール | `../open-virbicoin-pool` | [github.com/virbicoin/vbc-pool](https://github.com/virbicoin/vbc-pool) |
...
- **open-virbicoin**: 同一の VirBiCoin ネットワーク（chainId 329）に接続する代替クライアント（Ovbc, Rust 実装）。Gvbc とは別実装
